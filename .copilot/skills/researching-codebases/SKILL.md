...
description: Use when answering complex questions about a codebase that require exploring multiple areas or understanding how components connect - coordinates parallel helpers to locate, analyze, and synthesize findings
---

# Researching Codebases

Coordinate parallel helpers to answer complex codebase questions.
...
Launch multiple helpers concurrently for independent tasks using your platform's parallel-task capability.
